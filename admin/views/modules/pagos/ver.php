<?php 
	...
	<div class="row ">
			<div class="col-sm-6">
		        ...
		        <p class="text-primary">Estatus: <b>'.$a["Estado"] .'</b></p>
		        <p>Id de pago: <b>'.$a['id'].'</b></p><br><br>
		...
		<a href="panel.php?modulo=pagos&action=editar&id='.$hash.'&var=1"><button type="button" name="variable1" class="btn btn-primary mybtn">Aceptar Pago</button></a>
		<a href="panel.php?modulo=pagos&action=editar&id='.$hash.'&var=0"><button type="button" class="btn btn-danger mybtn">Cancelar Pago</button></a>
</div>
';
		}
		else{
