<?php 
	...
	<div class="row ">
			<div class="col-sm-6">
		        ...
		        <p>Id de factura: <b>'.$a['id'].'</b></p><br><br>
		...
		<a href="panel.php?modulo=pagos&action=editar&id='.$hash.'&var=0"><button type="button" class="btn btn-danger mybtn">Cancelar Factura</button></a>
</div>
';
		}
		else{
