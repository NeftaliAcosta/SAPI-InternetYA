...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sistema de Gestión de Pagos</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="panel.php?modulo=pagos"><i class="fa fa-money fa-fw"></i>Mi Pagos Pendientes</a>
                        </li>
                        <li>
                            <a href="panel.php?modulo=facturas"><i class="fa fa-shopping-cart fa-fw"></i>Mis Facturas Pagadas</a>
                        </li>
						<li>
                            <a href="panel.php?modulo=cancelaciones"><i class="fa fa-minus-circle fa-fw"></i>Mis pagos Cancelados</a>
                        </li>
                        <li>
                            <a href="panel.php?modulo=tickets"><i class="fa fa-support fa-fw"></i>Mis Tickets de Soporte</a>
                        </li>
						 <li>
    ...
    <!-- ModalBancarios -->
    <div id="ModalBancarios" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Detalles Bancarios</h4>
          </div>
          <div class="modal-body">
          <?php
